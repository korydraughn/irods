...
def setup_client_environment(irods_config):
    ...
    service_account_dict = {
        ...
        'irods_encryption_algorithm': irods_config.server_config['encryption_algorithm'],
        'irods_encryption_key_size': irods_config.server_config['encryption_key_size'],
        'irods_encryption_num_hash_rounds': irods_config.server_config['encryption_num_hash_rounds'],
        'irods_encryption_salt_size': irods_config.server_config['encryption_salt_size'],
