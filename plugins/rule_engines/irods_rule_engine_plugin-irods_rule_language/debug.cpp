...
int readRuleSetFromDB(char* ruleBaseName,
                      char* versionStr,
                      RuleSet* ruleSet,
                      ruleExecInfo_t* rei,
                      rError_t* errmsg,
...
char* getValByKey(keyValPair_t* condInput, char* keyWord)
{
    int i;
...
int checkStringForSystem(char* inString)
{
    return 0;
}
...
int clearGenQueryInp(genQueryInp_t* gqinp)
{
    return 0;
}
