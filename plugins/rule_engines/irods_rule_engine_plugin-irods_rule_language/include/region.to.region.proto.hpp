...
#define RE_STRUCT_FUNC_PROTO(T) T* RE_STRUCT_FUNC(T)(T * ptr, Region * r)

#define RE_STRUCT_GENERIC_FUNC_PROTO(T, cpfn) T* RE_STRUCT_FUNC(T)(T * ptr, Region * r, RegionRegionCopyFuncType * cpfn)
