...
int applyRuleUpdateParams(char* inAction,
                          msParamArray_t* inMsParamArray,
                          ruleExecInfo_t* rei,
                          int reiSaveFlag); // JMC - backport 4538
int applyRuleUpdateParams(char* inAction,
                          msParamArray_t* inMsParamArray,
                          ruleExecInfo_t* rei,
                          int reiSaveFlag); // JMC - backport 4539
...
int replaceArgVar(char* start, int size, char* args[MAX_NUM_OF_ARGS_IN_ACTION], int argc);
...
int executeMicroService(char* action, char* args[MAX_NUM_OF_ARGS_IN_ACTION], int argc, ruleExecInfo_t* rei);
