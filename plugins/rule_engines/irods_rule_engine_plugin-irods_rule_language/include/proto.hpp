...
#define RE_STRUCT_BEGIN(T) RE_STRUCT_FUNC_PROTO(T);

#define RE_STRUCT_BEGIN_NO_BUF(T) RE_STRUCT_FUNC_PROTO_NO_BUF(T);

#define RE_STRUCT_BEGIN_NO_BUF_PTR_DESC(T) RE_STRUCT_FUNC_PROTO_NO_BUF_PTR_DESC(T);

#define RE_STRUCT_GENERIC_BEGIN(T, cpfn) RE_STRUCT_GENERIC_FUNC_PROTO(T, cpfn);
