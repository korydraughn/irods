...
/** AST evaluators */
Res* evaluateActions(Node* ruleAction,
                     Node* ruleRecovery,
                     int applyAll,
                     ruleExecInfo_t* rei,
                     int reiSaveFlag,
                     ...
                     rError_t* errmsg,
                     Region* r);
Res* evaluateExpression3(Node* node,
                         int applyAll,
                         int force,
                         ruleExecInfo_t* rei,
                         int reiSaveFlag,
...
Res* evaluateFunctionApplication(Node* func,
                                 ...
                                 rError_t* errmsg,
                                 Region* r);
Res* evaluateFunction3(Node* appNode,
                       int applyAll,
                       Node* astNode,
                       Env* env,
                       ruleExecInfo_t* rei,
...
Res* execAction3(char* fn,
                 ...
                 rError_t* errmsg,
                 Region* r);
Res* execMicroService3(char* inAction,
                       Res** largs,
                       unsigned int nargs,
                       Node* node,
                       Env* env,
