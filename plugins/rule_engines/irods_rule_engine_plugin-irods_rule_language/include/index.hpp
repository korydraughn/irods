...
RuleIndexListNode* newRuleIndexListNode2(CondIndexVal* civ,
...
/* 4. the rule conditions are all of the form exp = "string", where exp is the same and "string" is distinct for all
 * rules */
