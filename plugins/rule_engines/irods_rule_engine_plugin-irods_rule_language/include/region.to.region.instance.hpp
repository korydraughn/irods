...
#define TRAVERSE_PTR(fn, f) CASCADE_NULL(ptr->f = fn(ptr->f, r));
...
#define TRAVERSE_PTR_TAPP(fn, f, cpfn) CASCADE_NULL(ptr->f = fn(ptr->f, r, cpfn));
...
#define NO_COPY_IN_REGION(f) if (!IN_REGION(ptr->f, r))
