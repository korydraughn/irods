...
int cmlGetRowFromSql(const char* sql, char* cVal[], int cValSize[], int numOfCols, icatSessionStruct* icss);
...
int cmlGetRowFromSqlV3(const char* sql, char* cVal[], int cValSize[], int numOfCols, icatSessionStruct* icss);
...
int cmlCheckGroupAdminAccess(const char* userName,
                             const char* userZone,
