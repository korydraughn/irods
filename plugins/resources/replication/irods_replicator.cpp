...
namespace irods
{
    replicator::replicator(oper_replicator* _oper_replicator)
    ...
    error replicator::replicate(plugin_context& _ctx, const child_list_t& _siblings, object_list_t& _opers)
    {
