...
irods::error readMsgHeader(irods::network_object_ptr,  // network object
                           msgHeader_t*,               // header
                           struct timeval*);           // time value
irods::error readMsgBody(irods::network_object_ptr,    // network object
                         msgHeader_t*,                 // header
                         ...
                         struct timeval*);             // time value
irods::error writeMsgHeader(irods::network_object_ptr, // network object
                            const msgHeader_t*);       // header structure
irods::error sendRodsMsg(irods::network_object_ptr,    // network object,
...
irods::error readVersion(irods::network_object_ptr, // network object
                         version_t**);              // version info
irods::error sendVersion(irods::network_object_ptr, // network object
                         int,                       // version status
