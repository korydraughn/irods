...
namespace irods
{
    ...
    public:
        ...
        // con/de structors
        buffer_crypt();
        buffer_crypt(int,          // key size in bytes
        ...
        irods::error encrypt(const array_t&, // key
        ...
        irods::error decrypt(const array_t&, // key
                             const array_t&, // initialization vector
        ...
        irods::error initialization_vector(array_t&); // intialization vector

        /// =-=-=-=-=-=-=-
        /// @brief generate a random byte key
        static irods::error generate_key(array_t&, // random byte key
                                         int);     // key size in bytes

        /// =-=-=-=-=-=-=-
        /// @brief hex encode buffer_crypt::array_t
        static irods::error hex_encode(const array_t&, // bytes to encode
