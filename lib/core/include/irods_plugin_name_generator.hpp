...
namespace irods
{
    ...
    public:
        ...
        /// @brief Constructs a library name from the plugin name and returns true if the library exists and is
        /// readable.
    ...
    private:
        /// @brief Generates a plugin name from a shared object file name or an empty string if it is not a shared
        /// object.
