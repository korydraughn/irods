...
#define RE_THROW(_msg, _excp)                                                                                          \
    _excp.add_message(_msg);                                                                                           \
    throw _excp;
#define CATCH_EXC_AND_RETURN(throwing_expression)                                                                      \
    try {                                                                                                              \
        throwing_expression;                                                                                           \
    }                                                                                                                  \
        ...
        rodsLog(LOG_ERROR,                                                                                             \
                e.code(),                                                                                              \
                "%s encountered an exception on line %d in file %s:\n%s",                                              \
                __PRETTY_FUNCTION__,                                                                                   \
                __LINE__,                                                                                              \
                __FILE__,                                                                                              \
                e.what());                                                                                             \
...
#define CATCH_EXC_AND_LOG(throwing_expression)                                                                         \
    try {                                                                                                              \
        throwing_expression;                                                                                           \
    }                                                                                                                  \
    catch (const irods::exception& e) {                                                                                \
