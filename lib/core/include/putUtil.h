...
#define DEF_PHY_BUN_ROOT_DIR "/tmp"
    ...
    int putUtil(rcComm_t** myConn, rodsEnv* myEnv, rodsArguments_t* myRodsArgs, rodsPathInp_t* rodsPathInp);
    ...
    int bulkPutFileUtil(rcComm_t* conn,
                        ...
                        bulkOprInp_t* bulkOprInp,
                        bulkOprInfo_t* bulkOprInfo);
    int tarAndBulkPut(rcComm_t* conn, bulkOprInp_t* bulkOprInp, bulkOprInfo_t* bulkOprInfo, rodsArguments_t* rodsArgs);
