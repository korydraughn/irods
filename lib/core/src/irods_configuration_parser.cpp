...
namespace irods
{
    ...
    configuration_parser::configuration_parser(const configuration_parser& _rhs)
    {
    ...
    configuration_parser& configuration_parser::operator=(const configuration_parser& _rhs)
    {
    ...
    error configuration_parser::copy_and_swap(const std::unordered_map<std::string, boost::any>& _rhs)
    {
        ...
        try {
            if (root_.empty()) {
                ...
                const auto& json_object =
                    boost::any_cast<const std::unordered_map<std::string, boost::any>&>(json_object_any);
    ...
    std::string to_env(const std::string& _v)
    {
        return boost::to_upper_copy<std::string>(_v);
    }
