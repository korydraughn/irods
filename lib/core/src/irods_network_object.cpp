...
namespace irods
{
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    network_object::network_object(const rcComm_t& _comm)
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    network_object::network_object(const rsComm_t& _comm)
        : socket_handle_(_comm.sock)
    {
    } // ctor
    ...
    // =-=-=-=-=-=-=-
    // public - cctor
    network_object::network_object(const network_object& _rhs)
    ...
    network_object& network_object::operator=(const network_object& _rhs)
    {
        socket_handle_ = _rhs.socket_handle_;
        return *this;
    ...
    bool network_object::operator==(const network_object& _rhs) const
    {
    ...
    error network_object::get_re_vars(rule_engine_vars_t& _kvp)
    {
        std::stringstream ss;
        ss << socket_handle_;
