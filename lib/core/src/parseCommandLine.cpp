    ...
    if (includeLong) {
        for (int i = 0; i < argc; i++) {
            ...
            if (strcmp("--ttl", argv[i]) == 0) {
                ...
                if (i + 2 <= argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--ttl option needs a time to live number");
            ...
            if (strcmp("--retries", argv[i]) == 0) { /* also -Y */
                ...
                if (i + 2 <= argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--retries option needs an iput file");
                        return USER_INPUT_OPTION_ERR;
                    }
            ...
            if (strcmp("--lfrestart", argv[i]) == 0) {
                ...
                if (i + 2 <= argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--lfrestart option needs an iput file");
                        return USER_INPUT_OPTION_ERR;
                    }
            ...
            if (strcmp("--age", argv[i]) == 0) { /* also -Y */
                ...
                if (argc >= i + 2) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--age option needs an iput number");
                        return USER_INPUT_OPTION_ERR;
                    }
            ...
            if (strcmp("--attr", argv[i]) == 0) {
                ...
                if (i + 2 <= argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--attr option needs an iput file");
                        return USER_INPUT_OPTION_ERR;
                    }
            ...
            if (strcmp("--var", argv[i]) == 0) {
                ...
                if (i + 2 <= argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--var option needs an iput parameter");
                        return USER_INPUT_OPTION_ERR;
                    }
            ...
            if (strcmp("--subset", argv[i]) == 0) {
                ...
                if (i + 2 <= argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--subset option needs an iput parameter");
                        return USER_INPUT_OPTION_ERR;
                    }
            ...
            if (strcmp("--new", argv[i]) == 0) {
                ...
                if (i + 2 <= argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--new option needs an starting time index iput ");
                        return USER_INPUT_OPTION_ERR;
                    }
            ...
            if (strcmp("--exclude-from", argv[i]) == 0) {
                ...
                if (i + 2 < argc) {
                    if (*argv[i + 1] == '-') {
                        rodsLog(LOG_ERROR, "--exclude-from option takes a file argument");
                        return USER_INPUT_OPTION_ERR;
                    }
