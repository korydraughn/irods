...
namespace irods
{
    ...
    error children_parser::list(children_map_t& list)
    {
        list = children_list_;
        return SUCCESS();
    }

    error children_parser::str(std::string& ret_string) const
    {
    ...
    error children_parser::add_child(const std::string& child, const std::string& context)
    {
        error ret = SUCCESS();
    ...
    error children_parser::remove_child(const std::string& child)
    {
        error ret = SUCCESS();
    ...
    error children_parser::first_child(std::string& _child)
    {
    ...
    error children_parser::last_child(std::string& _child)
    {
        error result = SUCCESS();
        if (children_list_.begin() != children_list_.end()) {
    ...
    error children_parser::set_string(const std::string& str)
    {
        error result = SUCCESS();
