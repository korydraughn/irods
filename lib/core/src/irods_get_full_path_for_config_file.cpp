...
namespace irods
{
    error get_full_path_for_config_file(const std::string& _cfg_file, std::string& _full_path)
    {
    ...
    error get_full_path_for_unmoved_configs(const std::string& _cfg_file, std::string& _full_path)
    {
        namespace fs = boost::filesystem;
