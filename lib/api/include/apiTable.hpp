...
#    error "exactly one of {CREATE_API_TABLE_FOR_SERVER, CREATE_API_TABLE_FOR_CLIENT} must be defined"
    ...
    {FILE_GET_FS_FREE_SPACE_AN,
     ...
     0,
     boost::any(
         std::function<int(rsComm_t*, fileGetFsFreeSpaceInp_t*, fileGetFsFreeSpaceOut_t**)>(RS_FILE_GET_FS_FREE_SPACE)),
     "api_file_get_fs_free_space",
     irods::clearInStruct_noop,
    ...
    {GET_TEMP_PASSWORD_FOR_OTHER_AN,
     ...
     0,
     boost::any(std::function<int(rsComm_t*, getTempPasswordForOtherInp_t*, getTempPasswordForOtherOut_t**)>(
         RS_GET_TEMP_PASSWORD_FOR_OTHER)),
     "api_get_temp_password_for_other",
     irods::clearInStruct_noop,
    ...
    {GET_LIMITED_PASSWORD_AN,
     ...
     0,
     boost::any(
         std::function<int(rsComm_t*, getLimitedPasswordInp_t*, getLimitedPasswordOut_t**)>(RS_GET_LIMITED_PASSWORD)),
     "api_get_limited_password",
     irods::clearInStruct_noop,
    ...
    {GET_HIER_FOR_RESC_AN,
     ...
     0,
     boost::any(
         std::function<int(rsComm_t*, getHierarchyForRescInp_t*, getHierarchyForRescOut_t**)>(RS_GET_HIER_FOR_RESC)),
     "api_get_hierarchy_for_resc",
     irods::clearInStruct_noop,
