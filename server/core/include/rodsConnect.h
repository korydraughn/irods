...
queueConfigName( rodsServerHost_t *configServerHost,
               rodsServerHost_t *myRodsServerHost );
int
getAndConnRcatHost( struct RsComm *rsComm, int rcatType, const char *rcatZoneHint,
                    rodsServerHost_t **rodsServerHost );
int
getAndConnRcatHostNoLogin( struct RsComm *rsComm, int rcatType, char *rcatZoneHint,
                           rodsServerHost_t **rodsServerHost );
int
...
int
svrReconnect( struct RsComm *rsComm );
int
getAndConnRemoteZone( struct RsComm *rsComm, struct DataObjInp *dataObjInp,
                      rodsServerHost_t **rodsServerHost, char *remotZoneOpr );
int
getReHost( rodsServerHost_t **rodsServerHost );
int
getAndConnReHost( struct RsComm *rsComm, rodsServerHost_t **rodsServerHost );
int
...
int
getRemoteZoneHost( struct RsComm *rsComm, struct DataObjInp *dataObjInp,
                   rodsServerHost_t **rodsServerHost, char *remotZoneOpr );
int
...
int
resoAndConnHostByDataObjInfo( struct RsComm *rsComm, struct DataObjInfo *dataObjInfo,
                              rodsServerHost_t **rodsServerHost );
int
printZoneInfo();
int
