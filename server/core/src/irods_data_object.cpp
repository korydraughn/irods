...
namespace irods
{
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    data_object::data_object(const std::string& _phy_path, rodsLong_t _resc_id, int _mode, int _flags)
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    data_object::data_object(const std::string& _phy_path,
                             rodsLong_t _resc_id,
                             int _mode,
                             int _flags,
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    data_object::data_object(const std::string& _phy_path, const std::string& _resc_hier, int _mode, int _flags)
        : physical_path_(_phy_path)
    ...
    // =-=-=-=-=-=-=-
    // public - cctor
    data_object::data_object(const data_object& _rhs)
    ...
    data_object& data_object::operator=(const data_object& _rhs)
    {
        physical_path_ = _rhs.physical_path_;
        resc_hier_ = _rhs.resc_hier_;
        resc_id_ = _rhs.resc_id_;
    ...
    error data_object::get_re_vars(rule_engine_vars_t& _kvp)
    {
    ...
    {
        addKeyVal(&_do->cond_input_, (char*) _k.c_str(), (char*) _v.c_str());
    }

    void remove_key_val(data_object_ptr& _do, const std::string& _k)
    {
        rmKeyVal(&_do->cond_input_, (char*) _k.c_str());
    }
}; // namespace irods
