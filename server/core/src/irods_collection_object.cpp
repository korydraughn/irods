...
namespace irods
{
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    collection_object::collection_object(const std::string& _fn, rodsLong_t _resc_id, int _m, int _f)
        : data_object(_fn, _resc_id, _m, _f)
        , directory_pointer_(0)
    {
    } // collection_object
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    collection_object::collection_object(const std::string& _fn,
                                         rodsLong_t _resc_id,
                                         int _m,
                                         int _f,
                                         const keyValPair_t& _cond_input)
        : data_object(_fn, _resc_id, _m, _f, _cond_input)
        , directory_pointer_(0)
    {
    } // collection_object
    ...
    // =-=-=-=-=-=-=-
    // public - ctor
    collection_object::collection_object(const std::string& _fn, const std::string& _resc_hier, int _m, int _f)
        : data_object(_fn, _resc_hier, _m, _f)
        , directory_pointer_(0)
    {
    } // collection_object
    ...
    collection_object::collection_object(const std::string& _fn,
                                         ...
                                         int _f,
                                         const keyValPair_t& _cond_input)
        : data_object(_fn, _resc_hier, _m, _f, _cond_input)
        , directory_pointer_(0)
    {
    } // collection_object
    ...
    error collection_object::resolve(const std::string& _interface, plugin_ptr& _ptr)
    {
        // =-=-=-=-=-=-=-
    ...
    error collection_object::get_re_vars(rule_engine_vars_t& _kvp)
    {
