    ...
    namespace re_serialization
    {
        ...
        static error serialize_float_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast float*");
            }
        ...
        static error serialize_const_std_string_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast const_std_string*");
            }
        ...
        static error serialize_std_string_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast std_string_ptr");
            }
        ...
        static error serialize_std_string(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast std_string*");
            }
        ...
        static error serialize_hierarchy_parser_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast hierarchy_parser_ptr*");
            }
        ...
        static error serialize_rodslong(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast rodslong");
            }
        ...
        static error serialize_sizet(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast sizet");
            }
        ...
        static error serialize_int(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast int");
            }
        ...
        static error serialize_int_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast int ptr");
            }
        ...
        static error serialize_char_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast char ptr");
            }
        ...
        static error serialize_const_char_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast const char ptr");
            }
        ...
        static error serialize_rsComm_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                if (l) {
                    ...
                    if (l->auth_scheme) {
                        _out["auth_scheme"] = l->auth_scheme;
                    }
                    ...
                    _out["proxy_auth_info_auth_flag"] =
                        boost::lexical_cast<std::string>(l->proxyUser.authInfo.authFlag);
                    ...
                    _out["user_auth_info_auth_flag"] =
                        boost::lexical_cast<std::string>(l->clientUser.authInfo.authFlag);
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast rsComm ptr");
            }
        ...
        static error serialize_plugin_context(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast plugin_context");
            }
        ...
        static error serialize_dataObjInp_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast dataObjInp ptr");
            }
        ...
        static error serialize_authResponseInp_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast authResponseInp*");
            }
        ...
        static error serialize_keyValPair_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast keyValPair ptr");
            }
        ...
        static error serialize_userInfo_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast userInfo ptr");
            }
        ...
        static error serialize_collInfo_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast collInfo ptr");
            }
        ...
        static error serialize_modAVUMetaInp_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast modAVUMetaInp ptr");
            }
        ...
        static error serialize_modAccessControlInp_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                if (l) {
                    ...
                    if (l->accessLevel) {
                        _out["access_level"] = l->accessLevel;
                    }
                    if (l->userName) {
                        _out["user_name"] = l->userName;
                    }
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast modAccessControlInp ptr");
            }
        ...
        static error serialize_modDataObjMeta_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                if (l) {
                    error ret = serialize_dataObjInfo_ptr(l->dataObjInfo, _out);
                    if (!ret.ok()) {
                        irods::log(PASS(ret));
                    }
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast modDataObjMeta ptr");
            }
        ...
        static error serialize_ruleExecSubmitInp_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast ruleExecSubmitInp ptr");
            }
        ...
        static error serialize_dataObjCopyInp_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                if (l) {
                    ...
                    error ret = serialize_dataObjInp_ptr(l->srcDataObjInp, src);
                    if (!ret.ok()) {
                        irods::log(PASS(ret));
                    }
                    else {
                    ...
                    ret = serialize_dataObjInp_ptr(l->destDataObjInp, dst);
                    if (!ret.ok()) {
                        irods::log(PASS(ret));
                    }
                    else {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast dataObjCopyInp ptr");
            }
        ...
        static error serialize_rodsObjStat_ptr_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast rodsObjStat ptr ptr");
            }
        ...
        static error serialize_rodsObjStat_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast rodsObjStat ptr");
            }
        ...
        static error serialize_genQueryInp_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast genQueryInp ptr");
            }
        ...
        static error serialize_genQueryOut_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                if (tmp) {
                    ...
                    for (int i = 0; i < l->attriCnt; ++i) {
                        for (int j = 0; j < l->rowCnt; ++j) {
                            ...
                            _out["value_" + j_str + "_" + i_str] =
                                boost::lexical_cast<std::string>(l->sqlResult[i].value + j * l->sqlResult[i].len);
                        }
                    }
                }
                else {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast genQueryOut ptr");
            }
        ...
        static error serialize_char_ptr_ptr(boost::any _p, serialized_parameter_t& _out)
        {
            try {
                ...
                return ERROR(INVALID_ANY_CAST, "failed to cast char ptr ptr");
            }
        ...
        error add_operation(const index_t& _index, operation_t _operation)
        {
            ...
            if (the_map.find(_index) != the_map.end()) {
                return ERROR(KEY_NOT_FOUND, "type_index exists");
            }
