...
/// Returns the active random scheme suffix style.
///
/// \since 5.1.0
int get_random_scheme_suffix_style();

/// Sets the random scheme suffix style.
///
...
///
/// \param[in] _suffix_style \parblock The new style of the randomly-generated suffix string. A value of
///                          1 results in 5 randomly generated alphanumeric characters being appended to
///                          the physical path. Attempting to set the value to anything other than 0 or 1
///                          will result in a warning being logged and the system continuing with the
///                          previous value. See #msi_set_random_scheme_suffix_length for information
///                          about changing the length of the generated suffix string.
///                          \endparblock
/// \param[in] _rei          A pointer to a #RuleExecInfo object. The execution information. Hidden
///                          within the iRODS Rule Language.
///
/// \since 5.1.0
int msi_set_random_scheme_suffix_style(MsParam* _suffix_style, ruleExecInfo_t* _rei);

/// Returns the active random scheme suffix length.
///
/// \since 5.1.0
int get_random_scheme_suffix_length();

/// Sets the random scheme suffix length.
///
/// The effects of this microservice are not applied unless the random scheme suffix style is set to 1.
/// See #msi_set_random_scheme_suffix_style for more information.
///
/// \param[in] _suffix_length The new length of the randomly-generated suffix string. The value must
///                           satisfy the range [0, 32]. Failing to satisfy this requirement will
///                           result in a warning being logged and the system continuing with the
///                           previous value.
/// \param[in] _rei           A pointer to a #RuleExecInfo object. The execution information. Hidden
///                           within the iRODS Rule Language.
///
